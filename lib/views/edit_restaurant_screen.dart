...
class _EditRestaurantScreenState extends State<EditRestaurantScreen> {
  ...
  final List<String> _categorias = ['Mexicana', 'Italiana', 'Sushi', 'Hamburguesas', 'Café', 'Pizza', 'Alitas'];
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: const Icon(Icons.restaurant, size: 40, color: Colors.teal),
                    ),
                  ),
                  Positioned(
                    bottom: -40,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Fotos del Restaurante', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    const SizedBox(height: 8),
                    SizedBox(
                      height: 160,
                      child: EditableAutoCarousel(
                        items: [
                          ...
                          {'text': 'Foto Interior', 'color': Colors.blueGrey.shade300},
                        ],
                      ),
                    ),
            ...
            TextButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Imagen borrada')), // Mensajito temporal abajo
                );
              },
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: IconButton(
                  ...
                  constraints: const BoxConstraints(),
                  padding: const EdgeInsets.all(8), // Padding ajustado para que sea fácil de tocar
                  onPressed: () {
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    _showDeleteConfirmation(context); // Llama a la alerta de borrado
                  },
                ),
              ),
            ),
